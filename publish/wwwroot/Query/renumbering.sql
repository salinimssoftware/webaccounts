...
/****** Object:  StoredProcedure [dbo].[ACCOUNTVOUCHER_RENUMERING]    Script Date: 08/23/2024 10:32:40 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER       PROCEDURE [dbo].[ACCOUNTVOUCHER_RENUMERING]  
(  
...
SET @Counter = 1
	...
	--UPDATE ##accmain_temp SET EditedRenumUser = @User;
